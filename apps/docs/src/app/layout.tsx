...
export const metadata: Metadata = {
  ...
  title: {
    default: 'aec-auth | The Token Layer for AEC APIs',
    template: '%s | aec-auth',
  },
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://aec-auth.dev',
    siteName: 'aec-auth',
    title: 'aec-auth | The Token Layer for AEC APIs',
    description: DESCRIPTION,
    images: [{ url: '/og', width: 1200, height: 630, alt: 'aec-auth' }],
  },
  twitter: {
    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm dark:bg-neutral-950/90">
      <div className="flex h-14 items-center justify-between px-4 gap-6">
        <div className="flex items-center gap-2">
          <Link href="/">
            <span className={`${GeistPixelSquare.className} text-lg`}>aec-auth</span>
          </Link>
        </div>
        <nav className="flex items-center gap-4">
          ...
          <a
            href="https://www.npmjs.com/package/aec-auth"
            target="_blank"
            rel="noopener noreferrer"
